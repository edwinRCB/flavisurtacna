        ...
        <div class="panel-heading">Editar Docente</div>
          <div class="panel-body">
            <div class="form-horizontal"> 
              {!! Form::model($docentemodel, ['route' =>['profesores.docente.update', $docentemodel->id], 'method' => 'PUT'])!!}
                ...
                <div class="form-group">
                  {!! Form::label('', 'Dirección:',['class'=>'col-lg-2 control-label']) !!}
                    <div class="col-lg-8">
                     {!! Form::text('direccion', null, ['class'=>'form-control', 'placeholder'=>'apellidos'])!!}
                    </div>
                </div>
                <div class="form-group">
