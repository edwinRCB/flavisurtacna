<div class="modal fade" id="registrarNotasCETPRO2">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
          <h4 class="modal-title">Registro de Notas PRUEBA</h4>
      </div>
      <div class="modal-body">
        <div class="form-horizontal"> 
          {!! Form::Open(['route' => ['usuarios.calificacionescetpro2.update'], 'method' => 'PUT', 'id'=>'form-update'])!!}
            ...
            <!-- -->
            {!! Form::hidden('detalleinscripcion_id', '', ['id' => 'detalle_data']) !!}
            <div class="form-group">
