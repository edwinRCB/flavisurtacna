  ...
  <div class="row">
    <div class="col-md-8 col-md-offset-2">
      <div class="panel panel-default">
        <div class="panel-heading">Matricular Alumno CETPRO</div>
          ...
          @endif
            ...
            <div class="form-horizontal"> 
              {!! Form::Open(['route' =>['cetpromatricula.matriculacetpro.store'], 'method' => 'POST'])!!}
              ...
              <div class="form-group">
                ...
                <div class="modal-footer">
                  ...
                  <a class="btn btn-warning" id="verificar" href="#">Verificar Alumno</a>
