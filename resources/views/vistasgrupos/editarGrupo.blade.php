        ...
        <div class="panel-heading">Actualizar Grupo: {{$grupos->carreras->nombre}}</div>
          <div class="panel-body">
            <div class="form-horizontal"> 
              {!! Form::model($grupos, ['route' =>['generalgrupo.grupo.update', $grupos->id], 'method' => 'PUT'])!!}
                ...
                <div class="modal-footer">
                  <a class="btn btn-default" href="{{ url('/generalgrupo/grupo')}}">Volver</a>
                            ...
                            <tbody>
                              ...
                              <tr data-id= "{{$detalles->id}}">
                                ...
                                <td data-id="{{$detalles->cursos->nombre}}">
                                  ...
                                  <a href="{{ route('generalgrupo.grupo.show', $detalles->id) }}" class="btn btn-warning btn-xs", target="_blank"><span class="glyphicon glyphicon-list"></span></a>
                                </td>
                              </tr>
                              @endforeach
                            </tbody>
