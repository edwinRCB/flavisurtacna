        ...
        <div class="panel-heading">Matricular Alumno</div>
          <div class="panel-body">
            <div class="form-horizontal"> 
              {!! Form::Open(['route' =>['institutomatricula.matricula.store'], 'method' => 'POST'])!!}
                ...
                <div class="form-group">
                {!! Form::label(':','Ciclos:',['class'=>'col-lg-2 control-label']) !!}
                <div class="col-lg-8">
                ...
                <div class="modal-footer">
                  <a class="btn btn-default" href="{{ url('/institutomatricula/matricula')}}">Volver</a>
                  <input type="submit" value="Matricula" class="btn btn-primary" data-toggle='modal' data-target="#Loading">
                </div>
...
@endsection
@section('scripts')
{!! Html::script('/js/matriculafINSTITUTO.js')!!}
