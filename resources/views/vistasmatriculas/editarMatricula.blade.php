        ...
        <div class="panel-heading" style="font-weight: bold"><center>Editar Matricula</center><BR>
          ...
          <div class="panel-body">
            <div class="form-horizontal"> 
              {!! Form::model($matriculaModel, ['route' =>['institutomatricula.matricula.update', $matriculaModel->id], 'method' => 'PUT'])!!}
                ...
                <div class="modal-footer">
                  ...
                  <input type="submit" value="Actualizar Matricula" class="btn btn-primary" data-toggle='modal' data-target="#Loading">
                </div>
                {!! Form::close() !!}
            </div>
          </div>
